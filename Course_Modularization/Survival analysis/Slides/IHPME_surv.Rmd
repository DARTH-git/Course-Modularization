...
author: "petros.pechlivanoglou@sickkids.ca"
date: "17/3/2020"
output:
...
- continuous data (linear modeling )
- binary/categorical/ count data (generalized linear modeling )
- ...but what about data that measure time until an event of interest? (Survival time data /Duration data )
...
========================================================
 - survival time $T$: the random variable capturing time since the beginning of the event. 
...
Testing the non-zero slope of the Schoenfeld residuals (more in the practical session)
