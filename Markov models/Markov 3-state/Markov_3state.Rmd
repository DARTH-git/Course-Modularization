...
p_HS <- 0.05                            # probability of becoming sick when healthy
p_SD <- 0.1                             # probability of dying when sick

# Costs and utilities  
c_H  <- 400                             # cost of one cycle when healthy
c_S  <- 1000                            # cost of one cycle when sick
c_D  <- 0                               # cost of one cycle when dead
