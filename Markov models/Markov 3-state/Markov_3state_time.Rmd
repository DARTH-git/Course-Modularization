...
p_HD <- seq(0.003, 0.01, length.out = n_t)  # probabilities to die when sick (age-dependent) - this is now a sequence of numbers, officially v_HD
...
valid <- apply(a_P, 3, function(x) all.equal(sum(rowSums(x)), n_s))
