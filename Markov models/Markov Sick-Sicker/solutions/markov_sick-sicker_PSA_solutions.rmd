...
```{r}
source(here::here("functions", "Functions_markov_sick-sicker.R"))
# Test function
...
save(df_psa_input, df_c, df_e, v_names_str, n_str,
     l_psa,
     file = here::here("output", "markov_sick-sicker_PSA_dataset.RData"))
```

## 09.3 Create probabilistic analysis graphs

```{r}
load(file = here::here("output", "markov_sick-sicker_PSA_dataset.RData"))
```
...
# As .RData
save(df_cea_psa, 
     file = here::here("tables", "markov_sick-sicker_probabilistic_CEA_results.RData"))
# As .csv
write.csv(df_cea_psa, 
          file = here::here("tables", "markov_sick-sicker_probabilistic_CEA_results.csv"))
```
