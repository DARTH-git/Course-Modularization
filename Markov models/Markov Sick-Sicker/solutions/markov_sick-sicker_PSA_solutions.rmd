...
v_names_params <- c('p_HD', 'p_HS1', 'p_S1H', 'p_S1S2', 'hr_S1', 'hr_S2', 'c_H', 'c_S1', 'c_S2', 'c_trt', 'c_D', 'u_H', 'u_S1',  
...
```{r}
source(here("functions", "Functions_markov_sick-sicker.R"))
# Test function
...
save(df_psa_input, df_c, df_e, v_names_str, n_str,
     l_psa,
     file = here("output", "markov_sick-sicker_PSA_dataset.RData"))
```
