...
```{r}
source(here::here("functions", "Functions_markov_sick-sicker_time.R"))
# Test function
...
owsa_nmb <- owsa_det(parms = c("p_S1S2", "u_S1", "c_trt", "u_trt"), # parameter names
                     ranges = list("p_S1S2" = c(0.05, 0.155),
                                   "u_S1"   = c(0.65, 0.85),
                                   "c_trt"  = c(6000, 18000),
                                   "u_trt"  = c(0.80, 0.98)),
...
save(df_psa_input, df_c, df_e, v_names_str, n_str,
     l_psa,
     file = here::here("output", "markov_sick-sicker_time_PSA_dataset.RData"))
```

## 09.3 Create probabilistic analysis graphs

```{r}
load(file = here::here("output", "markov_sick-sicker_time_PSA_dataset.RData"))
```
