...
=======
    p_HS     = rbeta(n_sim, alpha = 24, beta = 450), 
    p_HS_trt = rbeta(n_sim, alpha = 9, beta =281),   # under treatment
    # probability of dying when healthy
    p_HD     = rbeta(n_sim, alpha = 16, beta = 767),
    # probability of dying when sick
    p_SD     = rbeta(n_sim, alpha = 22.4, beta = 201.6), 
>>>>>>> 154d1a0eda448bf2bdc9b44a5268da66d72b4443
