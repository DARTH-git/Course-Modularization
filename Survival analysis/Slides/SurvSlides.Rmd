---
title: "Survival analysis in decision modeling"
...
```{r, out.width='100%', echo=F}
knitr::include_graphics('figures/psm.png')
```
...
```{r, out.width='100%', echo=F}
knitr::include_graphics('figures/psmcritic.png')
```
...
```{r, out.width='100%', echo=F}
knitr::include_graphics('figures/williams2017.png')
```
...
```{r, out.width='100%', echo=F}
knitr::include_graphics('figures/jacksonext.png')
```
...
knitr::include_graphics('figures/jacksonfig3.png')
```
...
```{r, out.width='100%', echo=F}
knitr::include_graphics('figures/latimercure.png')
```
