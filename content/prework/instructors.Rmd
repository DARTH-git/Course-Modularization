...
Hawre Jalal, MD, PhD, is an Associate Professor at the University of Ottawa, and Canada Research Chair in Health Economics. Prior to joining uOttawa, he was at the University of Pittsburgh as an Assistant Professor and prior to that he was a postdoc at Stanford University. Hawre's current research interests in R involves building models efficiently through reusing components.  He has recently published the gmod R package that uses the Grammar of Modelling concepts and Decision Twigs that constructs the interface for the gmod syntax.
