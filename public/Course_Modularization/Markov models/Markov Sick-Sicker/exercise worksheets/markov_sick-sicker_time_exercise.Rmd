...
Using the template `markov_sick-sicker_template.Rmd`, please do the following. 
...
| Annual mortality                   |             |               |
| - All-cause mortality (H to D)     | `p_HD`      | `HMD - info below`   |
...
* 1. *HMD* : This is the Human mortality database. We provide you a files called `HMD_USA_Mx_2015.csv` with the age specific mortality rates. The data has the columns X, Year, Age, Female, Male, Total and OpenInterval. We will use the overal age specific mortality rate from the Total column.

## Age specific all cause mortality
The code below shows you how to get the data into your R environment. We also provide this in the template
```{r, echo = FALSE}
