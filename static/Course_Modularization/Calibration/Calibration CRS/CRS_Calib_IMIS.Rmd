...
https://pubmed.ncbi.nlm.nih.gov/30248276/
...
# 07 Exploring posterior distribution
...
## 07.1 Model predicted outputs at maximum-a-posteriori (MAP)
```{r}
...
## 07.2 Distribution of model-predicted outputs
```{r}
...
### 07.2.1 Plot model-predicted output at mode vs targets
```{r}
# set plot margins (helps plotting)
par(mar=c(5,4,4,4)) 
# TARGET 1: Survival ("Surv")
