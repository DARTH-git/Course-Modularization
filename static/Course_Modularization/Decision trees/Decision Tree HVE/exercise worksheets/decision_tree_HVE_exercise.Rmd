...
3. Use the `calculate_icers()` function from the `dampack` package to calculate the incremental costs, QALYs, ICERs and Incremental NMB of each strategy, using a willingness to pay of $100,000/QALY. Type `?calculate_icers()` to see function documentation.
