...
p_load("devtools", "scales", "ellipse", "lazyeval", "igraph",  "ggraph", "reshape2", "knitr", "stringr", "jsonlite", "rstudioapi", "tidyverse")                                               
...
open_tree(file_name = "HVEsolution", dir_name = getwd())
```
...
df_tree <- evaluate_model("HVEsolution", n_payoffs = 2)
```
