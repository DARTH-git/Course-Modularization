...
6. Erasmus School of Health Policy and Management, Rotterdam, The Netherlands
...
v_cost_biopsy <-    # cost of biopsy procedure
                 c(c_death_biopsy   + c_biopsy,   # cost of death (zero)
...
For the cost-effectiveness we make use uf the `calculate_icers` function from the `dampack` package.
