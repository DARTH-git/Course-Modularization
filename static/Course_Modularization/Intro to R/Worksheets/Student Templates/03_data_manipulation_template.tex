...
\NormalTok{temp1 <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(data, AGE }\OperatorTok{>}\DecValTok{60}\NormalTok{)}
\NormalTok{temp2 <-}\StringTok{ }\KeywordTok{select}\NormalTok{(temp1,RANDID, AGE)}
\KeywordTok{head}\NormalTok{(temp2)}

\CommentTok{# OR }

\KeywordTok{head}\NormalTok{(}\KeywordTok{select}\NormalTok{(}\KeywordTok{filter}\NormalTok{(data, AGE }\OperatorTok{>}\StringTok{ }\DecValTok{60}\NormalTok{), RANDID, AGE))}
\end{Highlighting}
\end{Shaded}
