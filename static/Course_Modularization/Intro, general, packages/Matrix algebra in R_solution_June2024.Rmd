...
matrixA * matrixA
matrixB * matrixC #Notice the error message about non-conformable arrays. These matrices are not the same dimensions and cannot be multiplied in this way!
```

Matrix multiplication `%*%`, on the other hand, follows a different set of rules, outlined in the course material. 
...
```{r}
matrixD <- matrix(c(10:19), nrow = 3, ncol = 3)
