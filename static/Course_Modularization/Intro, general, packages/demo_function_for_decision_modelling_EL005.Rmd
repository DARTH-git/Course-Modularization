...
In case your data has the same variable types, you can also work with dataframes. This is a common output for for example the cost-effectiveness results of a incremental cost-effectiveness analysis. 

```{r}
# PLEASE NOTE: THIS IS NOT FROMAL FUNCTION, 

v_cost    <- 
v_effects <- 
n_wtp     <- 

calculate_iNMB_two_treatments <- function(v_costs, v_effects, n_wtp){
