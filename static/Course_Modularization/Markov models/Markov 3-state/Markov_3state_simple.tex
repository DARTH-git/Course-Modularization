...
\NormalTok{v_init <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)                    }\CommentTok{# initial cohort distribution}
...
\CommentTok{## Check if transition probability matrices are valid}
...
\KeywordTok{check_sum_of_transition_array}\NormalTok{(m_P, }\DataTypeTok{n_states =}\NormalTok{ n_states, }\DataTypeTok{verbose =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
