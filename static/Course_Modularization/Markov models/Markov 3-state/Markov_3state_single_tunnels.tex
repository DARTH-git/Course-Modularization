...
\NormalTok{p_SD <-}\StringTok{ }\NormalTok{l}\OperatorTok{*}\NormalTok{g}\OperatorTok{*}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{n_tunnel_size)}\OperatorTok{^}\NormalTok{\{g}\DecValTok{-1}\NormalTok{\}     }\CommentTok{# probability of dying when sick (time-in-state dependent)}
...
\KeywordTok{check_sum_of_transition_array}\NormalTok{(a_P, }\DataTypeTok{n_states =}\NormalTok{ n_states_tunnels, }\DataTypeTok{n_cycles =}\NormalTok{ n_t, }\DataTypeTok{verbose =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
