...
v_init <- c("Healthy" = 1,
            "Sick"    = 0,
            "Dead"    = 0)  # initial cohort distribution (everyone allocated to the "healthy" state)
...
check_sum_of_transition_array(a_P_SoC,  n_states = n_states, n_cycles = n_t, verbose = TRUE)
check_sum_of_transition_array(a_P_trtA, n_states = n_states, n_cycles = n_t, verbose = TRUE)
check_sum_of_transition_array(a_P_trtB, n_states = n_states, n_cycles = n_t, verbose = TRUE)
```
