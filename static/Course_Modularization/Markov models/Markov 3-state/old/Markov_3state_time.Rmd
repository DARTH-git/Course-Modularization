...
r_SD      <- 0.1   # raet of dying when sick
...
### Converting rates to probabilitis
p_HS_SoC  <- 1 - exp( - r_HS_SoC)  # probability  of becoming sick when healthy, conditional on surviving, under standard of care
p_HS_trtA <- 1 - exp( - r_HS_trtA)  # probability of becoming sick when healthy, conditional on surviving, under treatment A
p_HS_trtB <- 1 - exp( - r_HS_trtB)  # probability of becoming sick when healthy, conditional on surviving, under treatment B
p_SD      <- 1 - exp( - r_SD)   # probability of dying when sick
v_p_HD    <- 1 - exp( - v_r_HD) # probability of dying when healthy
