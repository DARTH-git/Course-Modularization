...
d_e       <- 0.03  # discount rate per cycle for effects
d_c       <- 0.03  # discount rate per cycle for costs   
...
```{r}
# Function in darthtools;
# verbose = Logical variable to indicate print out of messages. Default = TRUE
