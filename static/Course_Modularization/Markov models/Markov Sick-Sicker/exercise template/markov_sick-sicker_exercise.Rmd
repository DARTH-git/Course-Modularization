...
subtitle: 'Markov Model Exercise: the basics'
...
1.	Build the Markov model in `R` for Standard of Care (SoC) and Strategy AB.
...
| Annual mortality                                   |             |                |
| - Rate of dying when Healthy (all-cause mortality) | `r_HD`      |  0.002         |
