...
subtitle: 'Markov Model Exercise: with various dependencies'
...
Previously, you built a Markov of the Sick-Sicker model. In this exercise, you will expand on that model to incorporate dependence on time since model start and on state residence.
...
| - Disease progression (S1 to S2), conditional on surviving   | `v_p_S1S2`    | Weibull function |
| Annual mortality                   |             |               |
