...
p_HD     <- rate_to_prob(r = v_r_HD, t = 1) # probability to die when healthy (vector)
...
r_S1D    <- hr_S1 * v_r_HD  	       # rate of death in sick (vector)
r_S2D    <- hr_S2 * v_r_HD  	       # rate of death in sicker (vector)
p_S1D    <- rate_to_prob(r = r_S1D, t = 1)    # probability to die in sick (vector)
p_S2D    <- rate_to_prob(r = r_S2D, t = 1)    # probability to die in sicker (vector)
