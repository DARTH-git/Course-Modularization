...
a_P_notrt <- a_P_trt <- array(0,                                          # Create 3-D array
                   ...
                   dimnames = list(v_names_states, v_names_states, 0:(n_cycles-1))) # name and rows of the matrix
a_P_notrt[, , 1:3]
a_P_trt[, , 1:3]
```
...
a_P_notrt["H", "S1", ]  <- (1 - v_p_HD) *      p_HS1
a_P_notrt["H", "D",  ]  <- v_p_HD
# from Sick
a_P_notrt["S1", "H", ]  <- (1 - v_p_S1D) * p_S1H
a_P_notrt["S1", "S1", ] <- (1 - v_p_S1D) * (1 - (p_S1H + p_S1S2))
a_P_notrt["S1", "S2", ] <- (1 - v_p_S1D) * p_S1S2
a_P_notrt["S1", "D", ]  <- v_p_S1D
# from Sicker
...
check_sum_of_transition_array(a_P_notrt, n_states = n_states, n_cycles = n_cycles, verbose = TRUE)
