...
m_M_notrt <- m_M_trt <- matrix(NA, 
                               ...
                               dimnames = list(paste("cycle", 0:n_t, sep = " "), v_names_states_tunnels)) 
...
a_P_notrt <- array(0,  # Create 3-D array
                   ...
                   dimnames = list(v_names_states_tunnels, v_names_states_tunnels, 0:(n_t-1))) # name dimensions
```
...
check_sum_of_transition_array(a_P_notrt, n_states = n_states_tunnels, n_cycles = n_t, verbose = TRUE)
