...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{source}\NormalTok{(here}\OperatorTok{::}\KeywordTok{here}\NormalTok{(}\StringTok{"functions"}\NormalTok{, }\StringTok{"Functions_markov_sick-sicker_tunnels.R"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
