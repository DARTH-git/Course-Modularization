...
\StringTok{  }\KeywordTok{filter}\NormalTok{(Age }\OperatorTok{>=}\StringTok{ }\NormalTok{age }\OperatorTok{&}\StringTok{ }\NormalTok{Age }\OperatorTok{<=}\StringTok{ }\NormalTok{(max_age}\OperatorTok{-}\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{p_S1S2  <-}\StringTok{ }\NormalTok{l}\OperatorTok{*}\NormalTok{g}\OperatorTok{*}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\NormalTok{tunnel_size)}\OperatorTok{^}\NormalTok{\{g}\OperatorTok{-}\DecValTok{1}\NormalTok{\} }\CommentTok{# probability to become sicker when sick }
