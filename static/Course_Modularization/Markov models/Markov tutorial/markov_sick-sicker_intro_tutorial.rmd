...
- *Standard of Care (SoC)*: best available care for the patients with the disease. This scenario reflects the natural history of the 
...
matplot(l_m_M$`Standard of care`, type = 'l', 
...
plot(df_cea, label = "all") + expand_limits(x = max(table_cea$QALYs) + 0.5) 
```
...
df_params_owsa <- data.frame(pars = c("p_S1S2", "c_trtA", "u_S1", "u_trtA"),
...
# max values of the parameters of interest
df_params_twsa <- data.frame(pars = c("c_trtA", "u_trtA"),
