...
p_load("dplyr", "devtools", "scales", "ellipse", "ggplot2", "lazyeval", "igraph", "ggraph", "reshape2", "knitr", "dampack")                                               
...
Probs <- function(M_t, df_X) { 
  ...
  m_p_t["H",  M_t == "S1"] <- (1 - p_S1D) *      p_S1H 
  m_p_t["S1", M_t == "S1"] <- (1 - p_S1D) * (1 - p_S1H - p_S1S2)
  m_p_t["S2", M_t == "S1"] <- (1 - p_S1D) *              p_S1S2
  m_p_t["D",  M_t == "S1"] <-      p_S1D    
