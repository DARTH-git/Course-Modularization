...
subtitle: 'Includes individual characteristics: age, age dependent mortality probabilities, individual treatment effect modifyer, state-residence dependence for the sick (S1) state, increasing change of death in the first 6 year of sickness (tunnel)'
...
p_load("here", "dplyr", "devtools", "scales", "ellipse", "ggplot2", "lazyeval", "igraph", "ggraph", "reshape2", "knitr", "matrixStats")                                               
