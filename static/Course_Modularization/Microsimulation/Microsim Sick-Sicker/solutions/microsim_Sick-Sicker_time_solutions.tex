...
\CommentTok{# (all non-probabilities are conditional on survival)}
...
\NormalTok{  m_p_t[, M_t }\OperatorTok{==}\StringTok{ "H"}\NormalTok{]  <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{((}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_HD) }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_HS1),}
\NormalTok{                                (}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_HD) }\OperatorTok{*}\StringTok{ }\NormalTok{p_HS1,}
                                         \DecValTok{0}\NormalTok{,}
\NormalTok{                                     p_HD)                              }
  \CommentTok{# transition probabilities when sick}
\NormalTok{  m_p_t[, M_t }\OperatorTok{==}\StringTok{ "S1"}\NormalTok{] <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{((}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_S1D[df_X}\OperatorTok{$}\NormalTok{n_ts]) }\OperatorTok{*}\StringTok{ }\NormalTok{p_S1H, }
\NormalTok{                                (}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_S1D[df_X}\OperatorTok{$}\NormalTok{n_ts]) }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{( p_S1H }\OperatorTok{+}\StringTok{ }\NormalTok{p_S1S2)),}
\NormalTok{                                (}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{p_S1D[df_X}\OperatorTok{$}\NormalTok{n_ts]) }\OperatorTok{*}\StringTok{ }\NormalTok{p_S1S2,}
\NormalTok{                                     p_S1D[df_X}\OperatorTok{$}\NormalTok{n_ts])  }
...
\NormalTok{  QALYs <-}\StringTok{  }\NormalTok{u_t }\OperatorTok{*}\StringTok{ }\NormalTok{cl  }\CommentTok{# calculate the QALYs during cycle t}
  \KeywordTok{return}\NormalTok{(QALYs) }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    m_M [, }\DecValTok{1}\NormalTok{] <-}\StringTok{ }\KeywordTok{as.character}\NormalTok{(df_X}\OperatorTok{$}\NormalTok{M_init) }\CommentTok{# initial health state at cycle 0 for individual i}
...
\NormalTok{      m_P <-}\StringTok{ }\KeywordTok{Probs}\NormalTok{(m_M[, t], df_X, t)             }
      ...
      \CommentTok{# check if checks if each of the rows of the transition probabilities matrix sum to one}
...
\NormalTok{  te_hat <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(te)   }\CommentTok{# average (discounted) QALY }
...
\NormalTok{outcomes_no_trt  <-}\StringTok{ }\KeywordTok{MicroSim}\NormalTok{(}\DataTypeTok{n_i =}\NormalTok{ n_i, }\DataTypeTok{df_X =}\NormalTok{ df_X, }\DataTypeTok{Trt =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{seed =} \DecValTok{1}\NormalTok{)}
\NormalTok{outcomes_trt     <-}\StringTok{ }\KeywordTok{MicroSim}\NormalTok{(}\DataTypeTok{n_i =}\NormalTok{ n_i, }\DataTypeTok{df_X =}\NormalTok{ df_X, }\DataTypeTok{Trt =} \OtherTok{TRUE}\NormalTok{,  }\DataTypeTok{seed =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df_cea <-}\StringTok{ }\KeywordTok{calculate_icers}\NormalTok{(}\DataTypeTok{cost       =}\NormalTok{ v_C,}
