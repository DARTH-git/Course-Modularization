...
*TASK: Hawre could add an extra slot into the javascript to have payoff names (extra box in OpenTree)*
...
df_tree <- evaluate_model(opentree_df, params, treetype = "decision", n_payoffs = 2)
df_tree$`Do not treat`
```
