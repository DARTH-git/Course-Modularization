...
*TASK: remove prod in opentree df*

*TASK: set default params to be list = list()*

*TASK: use `if` to replace `treetype` argument (e.g. if ..$P_str)*

*Task: opentree_df instead of open_df$P_str*

*TASK: could provide either a character value with tree name or an open tree object*

*TASK: list of 2 things: transition prob and the trans prob matrix*

*TASK: make checking prob matrix functions in evaluate_model*
