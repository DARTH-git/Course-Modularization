...
\CommentTok{#Note: the function calculate_ce_out creates the outputs Cost, Effect and NMB. Those can be selected for the outcome }
\CommentTok{# You and also run the function for all 3 outcomes useind c("Cost", "Effect", "NMB"). Each outcome is stored in a list and can be indexed using the $ sign. }
\end{Highlighting}
\end{Shaded}
