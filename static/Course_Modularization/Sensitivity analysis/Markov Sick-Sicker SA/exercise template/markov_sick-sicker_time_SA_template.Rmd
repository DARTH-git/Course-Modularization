...
subtitle: "One-way, two-way and probabilistic sensitivity - this works build upon the first Sick-Sicker markov exercise"
...
In this sensitivity analysis exercise, you code several sensitivity analysis chuncks and end with a probabilistic sensitivity analysis with 1000 simulations `(n_sim)`. Table II describes the distributions for the variables you used in the previous exercise.
...
## Tasks
### Exercise - Task 1
Open the file `markov_sick-sicker_time_SA_template.R` and move to "10 Deterministic Sensitivity Analysis (DSA)". Run all code before this section. 
### Exercise - Task 2
Complete the `calculate_ce_out` function of the Sick-Sicker Markov model in the file `Functions_markov_sick-sicker_time.R`. Load this function file in to `R`.
### Exercise - Task 3
...
### Exercise - Task 8
Create the cost-effectiveness acceptability curves (CEAC) and frontier (CEAF) for the treatment comparison assuming WTP thresholds of $\$0$ to $\$200,000$.
### Exercise - Task 9
