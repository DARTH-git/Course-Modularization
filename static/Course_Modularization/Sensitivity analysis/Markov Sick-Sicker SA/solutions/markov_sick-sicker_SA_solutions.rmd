...
```{r Sick-Sicker-CEA, fig.cap='Cost-effectiveness efficient frontier of all four strategies for the time-independent Sick-Sicker model.', message=FALSE, warning=FALSE, fig.pos="H"}
