...
# This function alsways requires the Surv function to created survival objects
...
### Extra material
The following code chunk does the same as what we did before, but using the fit.fun from the `dampack`darthtools` package. Depending on your personal preferences you can use either one. 
...
For the best fitting survival models we fit the transition probabilities. We do this using the `trans_prob` function from the `darthtools` package.
