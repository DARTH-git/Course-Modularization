...
p_load( "dplyr", "devtools", "gems", "flexsurv", "flexsurvcure", "survminer", "survHE", "ggplot2", "msm", "igraph", "mstate", "reshape2", "knitr", "diagram", "abind", "DES", "dampack", "data.table")    
...
```{r}
saveRDS(sim_data, file = "PFS_OS_data_trt_sort.rds")
```
