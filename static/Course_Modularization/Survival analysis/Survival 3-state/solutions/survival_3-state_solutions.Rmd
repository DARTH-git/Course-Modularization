...
best_PFS <- fit_PFS$models[[choose_PFS]]  
# plot KM for PFS
...
PFS_superimpose  <- PFS_superimpose$plot + 
...
PFS_superimpose  <- PFS_superimpose + 
...
# OS
# Select the best fitted survivor function based on the smallest AIC
best_OS <- fit_OS$models[[choose_OS]]  
# plot KM for OS
...
plot_trace_PSM(time = times, partsurv.model = m_M_PSM_PSA, PA = T)
```
...
m_M_PSM$pfs.trans.prob
m_M_PSM$os.trans.prob
```
