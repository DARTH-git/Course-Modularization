...
p_load("here", "dplyr", "devtools", "gems", "flexsurv", "survHE", "ggplot2", "msm", "igraph", "mstate", "reshape2", "knitr", "abind", "DES", "survminer", "dampack")  
...
# fit independent models for each transition and pick the one that fits best
#your turn
fit_S1H  <- 
fit_S1S2 <- 
fit_S1D  <- 
